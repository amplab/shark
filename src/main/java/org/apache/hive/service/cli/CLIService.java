...
/**
 * Forgive me James Gosling for i have sinned...
 *
 * This is just a duplicate of the class found in hive... we need to call super.super.init() from our subclass and this
 * lets us do it through sharkInit
 *
 * Of course, the hive code doesn't actually use ICLIService as an interface so we have to reuse the name.  Be careful
 * with the ordering of your classpath :P
 *
 */
public class CLIService extends CompositeService implements ICLIService {
  ...
  public void sharkInit(HiveConf conf) {
    super.init(conf);
  }
